...
'''
kameradan goruntu almak istiyorsaniz "showCap" True yapiniz ama eger klasordeki fotograflar uzerinde islem yapmak istiyorsaniz
"showCam" False yaparak asagidaki foto degiskenine klasordeki bir fotografin adini veriniz!
cikis yapabilmek icin 'win' kapatmaniz yeterli olmayacak terminal kisminda ctrl+c tuslamaniz gerek.

vs code IDE'sinde yazilmistir
